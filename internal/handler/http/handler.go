...
func NewHandler(app application.Application) ClientHandler {
	return clientHandler{app: app}
}

func (h clientHandler) Handler(rw http.ResponseWriter, req *http.Request) {

	var routesClient = map[string]http.HandlerFunc{
		"get hermes_foods/client/{cpf}": h.getByCPF,
		"post hermes_foods/client":      h.save,
	}
...
func (h clientHandler) HealthCheck(rw http.ResponseWriter, req *http.Request) {
...
func (h clientHandler) getByCPF(rw http.ResponseWriter, req *http.Request) {
...
func (h clientHandler) save(rw http.ResponseWriter, req *http.Request) {
	var (
		buff      bytes.Buffer
